...
# Assumes that ~/.bananad doesn't exist
# can be modified to suit your purposes if ~/.bananad does already exist
...
# Initialize chain.
bananad init test --chain-id evmos_9000-1
...
# Start chain.
bananad start --x-crisis-skip-assert-invariants 
