...
# Initialize chain.
bananad init test --chain-id evmos_9000-2

# Get Genesis
wget https://archive.evmos.org/mainnet/genesis.json
mv genesis.json ~/.bananad/config/

wget -O ~/.bananad/config/adrbook.json https://snapshot.notional.ventures/evmos/addrbook.json
