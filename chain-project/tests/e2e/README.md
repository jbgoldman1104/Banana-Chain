...
# previous node state folder. By default this is './build/.bananad:/root/.bananad'
...
the test suite exports `/.bananad` folder from the docker container
...
Error:  Received unexpected error:
        ...
        main.appCreator.newApp({{{0x3399b40, 0xc000ec1db8}, {0x33ac0f8, 0xc00...
            github.com/evmos/evmos/v10/cmd/bananad/root.go:243 +0x2ca
        ...
        main.main()
            github.com/evmos/evmos/v10/cmd/bananad/main.go:20 +0x45
